...
import 'package:grabby_babby_admin/presentation/logic/preferences/add_preferences/add_preferences_cubit.dart';
import 'package:grabby_babby_admin/presentation/view/preferences/components/preferences_multiselect.dart';
...
import '../../../logic/preferences/add_preferences/add_preferences_state.dart';
          ...
          children: [
            ...
            Expanded(
              child: Container(
                ...
                child: BlocBuilder<AddPreferencesCubit, AddPreferencesState>(
                  builder: (context, state) {
                    final cubit = context.read<AddPreferencesCubit>();
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Gap(10),
                                        // show dropdown for preferences here
